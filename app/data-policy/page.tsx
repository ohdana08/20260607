...
export default function DataPolicyPage() {
  return (
    <PolicyPage title="AI·첨부자료 처리 안내" updatedLabel="최종 수정일: 2026-09-02">
      <Article title="1. AI 처리 안내">
        <p>
          본 서비스는 유료 사업계획서와 별도 발표자료의 인터뷰·근거 정리·전략 설계·문서 작성·수정을 위해
      ...
      <Article title="3. 처리 목적">
        <p>
          입력된 사업정보와 첨부자료는 공고 추천, 자격 진단, 사업계획서·발표자료 작성 및 근거 검증을 위한
      ...
      <Article title="5. 데이터 보관">
        <p>
          ...
          사이트 데이터를 지우면 삭제됩니다. 유료 작성 과정의 근거팩·전략팩·최종 점검·발표자료 기록은 문서의 사실성과
      ...
      <Article title="7. AI 생성물의 한계">
        <p>
          최종 Word와 별도 결제한 PPTX·PDF는 필수 근거 점검과 이용자 확인을 거친 뒤 제공하지만 모든 사실의 정확성이나 정부지원사업
          선정을 보장하지 않습니다. 근거 충돌 또는 필수 데이터 부족이 남아 있으면 최종 Word 다운로드를 막고,
          발표자료도 동일하게 파일 생성을 막아 이용자가 실제 자료를 추가·확인하도록 안내합니다.
        </p>
      </Article>

      <p className="pt-4 text-sm text-zinc-500">
        본 안내는 2026년 9월 2일부터 시행합니다.
      </p>
    </PolicyPage>
  );
}
